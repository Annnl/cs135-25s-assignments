...
def predict_0_hidden_layer(x_NF, w_arr, b_arr, output_activation):
    ...
    """
    sum = np.dot(x_NF,w_arr)+b_arr
    out_arr = output_activation(sum)         # TODO fixme
...
def predict_n_hidden_layer(
    ...
    for layer_id in range(n_layers):
        ...
        out_arr = np.dot(out_arr,w_arr)+b_arr  # TODO: fixme
        ...
        if layer_id != n_layers-1:
            out_arr = hidden_activation(out_arr)  # TODO: fixme
        else:
